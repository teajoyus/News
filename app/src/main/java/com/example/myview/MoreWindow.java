...
import com.example.util.KickBackAnimator;
...
public class MoreWindow extends PopupWindow implements OnClickListener {
    ...
    public void showMoreWindow(View anchor, int bottomMargin) {
        ...
        ImageView comment =(ImageView) layout.findViewById(R.id.iv_comment_sort);
        ImageView read =(ImageView)  layout.findViewById(R.id.iv_read_sort);
        ImageView love =(ImageView)  layout.findViewById(R.id.iv_love_sort_);
